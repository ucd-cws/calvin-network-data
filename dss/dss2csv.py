...
try:
    opts, args = getopt.getopt(sys.argv[1:],"lptd",["list","pd","ts","data"])
except getopt.GetoptError:
    print 'dssxml [-l] [--ts] [--pd] <dssfile>'
    sys.exit(2)
...
# DataContainer
#fullName,location,subVersion,version,watershed
# TS
#endTime,interval,numberValues,parameter,quality,startTime,subLocation,subParameter,times,timeZoneId,timeZoneRawOffset,type,units,values
